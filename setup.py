...
setup(
  ...
  name = '101703381_outlier',         # How you named your package folder (MyLib)

  packages = ['101703381_outlier'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/palkibansal31/Z_Score',    # I explain this later on
